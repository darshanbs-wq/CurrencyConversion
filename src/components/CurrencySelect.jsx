...
const CurrencySelect = ({SelectedCurrency,handleCurrency}) => {
 ...
 <option key={currency} className="dropbutton" value={currency}>{currency}</option>
        ))}
   
      <option className="dropbutton" value="INR">inr</option>
      <option className="dropbutton" value="AUD">aud</option>
    </select>
  </div>
  )
}
